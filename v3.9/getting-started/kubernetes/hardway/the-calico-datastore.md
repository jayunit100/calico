...
### Install calicoctl and configure it data source
...
```
export KUBECONFIG=/etc/kubernetes/admin.conf # This is the default location that kubeadm puts initial config.
